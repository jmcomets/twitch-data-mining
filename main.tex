...
Les difficultés rencontrées ont été varié sur ce projet. Premièrement, comme
les données étaient en deux parties bien distincts sous des formats différents,
il a fallu les extraires pour pouvoir tenter de les fusionner. Cela n'a pas été
...
avec la taille des données, la classification et la visualisation de traits a
été plus aisé. \\

On a donc pu établir quelques règles et quelques conditions pour prédire si un
flux va être populaire ou pas. Mais cela se fait qu'avec de la lecture et
